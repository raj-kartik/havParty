...
import LikeWise from '../../stack/LikeWise/LikeWise';
  ...
  return (
    <Container>
      <Stack.Navigator screenOptions={{headerShown: false}}>
        ...
        <Stack.Screen name="FamousBar" component={FamousBar} />
        <Stack.Screen name="LikeWise" component={LikeWise} />
        <Stack.Screen name="NearbyPlace" component={NearbyPlace} />
